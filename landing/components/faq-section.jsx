/* FAQ — 2-column accordion (same content style as repo's faq-section, condensed) */
      ...
      ${open ? 'bg-violet-500/[0.07] border-violet-500/40' : 'card-dark hover:border-violet-500/30'}`}
		>
			...
			>
				...
				<IChevronDown
					size={18}
					className={`text-slate-400 shrink-0 transition-transform duration-300 ${open ? 'rotate-180 text-violet-400' : ''}`}
				/>
			</button>
			<div
