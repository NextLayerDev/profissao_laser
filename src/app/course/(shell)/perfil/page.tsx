					...
					>
						<div className="flex items-center gap-5 mb-6">
							<div className="relative shrink-0">
								<div className="w-24 h-24 rounded-full overflow-hidden bg-violet-600 grid place-items-center text-white text-2xl font-bold border border-white/10">
									{profile?.avatar ? (
										<img
											src={profile.avatar}
											alt="Foto de perfil"
								...
								<button
									...
									title="Alterar foto"
									className="absolute -bottom-1 -right-1 w-8 h-8 rounded-full bg-violet-600 hover:bg-violet-500 text-white grid place-items-center border-2 border-white dark:border-[#1a1a1d] transition-colors disabled:opacity-60"
								>
