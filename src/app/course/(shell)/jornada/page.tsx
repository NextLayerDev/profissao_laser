		...
		<div className="p-4 md:p-8 max-w-4xl mx-auto">
			<div className="mb-8">
				<div className="flex items-center gap-3 mb-2">
					<div className="bg-gradient-to-br from-violet-500 to-cyan-500 rounded-lg p-2">
				...
				<div className="space-y-3">
					{items.map((item) => {
						...
						return (
							<div
								key={item.plan.id}
								className="bg-white dark:bg-[#1a1a1d] border border-slate-200 dark:border-gray-800/50 rounded-2xl overflow-hidden"
							>
								<div className="p-6">
