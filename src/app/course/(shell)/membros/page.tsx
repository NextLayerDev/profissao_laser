					...
					<div className="p-6 rounded-2xl bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 mb-6 shadow-lg dark:shadow-none">
						...
						<p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
							{upgradeTiers?.comunidade
								? `Os membros estao disponiveis no plano ${upgradeTiers.comunidade}. Faca upgrade para aceder.`
								: 'Os membros estao disponiveis apenas para planos com acesso a comunidade. Faca upgrade na loja para aceder.'}
						</p>
					</div>
					<Link
						href="/course/store"
