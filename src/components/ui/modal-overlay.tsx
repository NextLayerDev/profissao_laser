	...
	return (
		<ModalPortal>
			...
			>
				<div
					role="dialog"
					className={`relative overflow-hidden border border-slate-200 dark:border-white/10 rounded-xl shadow-2xl ${widthClassName} w-full max-h-[90vh] flex flex-col animate-[fade-in-up_0.25s_ease-out_both] ${dialogBg}`}
