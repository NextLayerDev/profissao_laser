...
export function ModalOverlay({
	...
	return (
		...
		>
			<div
				role="dialog"
				className="bg-white dark:bg-[#1a1a1d] border border-slate-200 dark:border-white/10 rounded-xl shadow-2xl max-w-lg w-full max-h-[90vh] overflow-y-auto animate-[fade-in-up_0.25s_ease-out_both]"
