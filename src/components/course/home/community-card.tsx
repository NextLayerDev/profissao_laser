	...
	return (
		<div className="bg-white dark:bg-[#1a1a1d] border border-slate-200 dark:border-gray-800/50 rounded-2xl p-5">
			...
			{features?.comunidade ? (
				<Link
					href="/comunity"
					className="w-full flex items-center justify-center gap-2 bg-gradient-to-r from-violet-600 to-fuchsia-600 hover:opacity-90 text-white font-semibold py-2.5 rounded-xl transition-all text-sm shadow-[0_0_15px_rgba(108,56,255,0.25)]"
				>
					<Users className="w-5 h-5" />
					Acessar comunidade
				</Link>
			) : (
				<div className="w-full flex items-center justify-center gap-2 bg-slate-50 dark:bg-gray-800/40 border border-slate-200 dark:border-gray-800/50 text-slate-400 dark:text-gray-600 font-medium py-2.5 rounded-xl text-sm cursor-not-allowed">
