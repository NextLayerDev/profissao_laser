				...
				<div className="space-y-3">
					{projects.map((p) => (
						...
						>
							...
							{/* Imagem 16:9 — mais compacta verticalmente */}
							{p.img ? (
								<Link
							...
							{/* Footer: ações */}
							<div className="flex items-center gap-4 px-3 py-2 border-t border-slate-100 dark:border-white/5 text-xs text-slate-500 dark:text-gray-400">
